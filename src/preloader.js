;(() => {
  ...
  function initPreloader() {
    ...
    styleTag.id = "preloader-styles"
    styleTag.textContent = `
      body > *:not(#coordinate-preloader) {
        opacity: 0 !important;
      }
    `
    ...
    function exitPreloader() {
      const bodyChildren = Array.from(document.body.children).filter((child) => child.id !== "coordinate-preloader")
